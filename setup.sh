...
if [[ ! -e .env  ]]; then
    ...
    echo "   auth.$DOMAIN           <docker_host_ip>            8083   ✓    ✓"
    echo "   element.$DOMAIN        <docker_host_ip>            8080   ✓    ✓"
    echo "   call.$DOMAIN           <docker_host_ip>            8082   ✓    ✓"
    echo "   livekit.$DOMAIN        <docker_host_ip>            7880   ✓    ✓"
    echo "   livekit-jwt.$DOMAIN    <docker_host_ip>            8084   ✓    ✓"
    ...
    echo "      - Route /_matrix/client/.*/login|logout|refresh to port 8083 (MAS)"
